...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = "C:\\Users\\nthor\\source\\repos\\DelegatesTaskNathanThorpe\\data.csv";  // change to appropriate path
        private string _tsvPath = "C:\\Users\\nthor\\source\\repos\\DelegatesTaskNathanThorpe\\data.tsv";  // change to appropriate path

        private string _writeFile = "C:\\Users\\nthor\\source\\repos\\DelegatesTaskNathanThorpe\\text.txt";  // change to appropriate path
